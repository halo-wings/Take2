...
?>
	<div class="content">
		<div class="left">
			<img src="../../images/img_gauche_publications.jpg" alt="Publications" />
		...
		<div class="right">
			...
			<section>
				<div class="wrapper">
				<h1>Publications et propri&eacute;t&eacute; intellectuelle depuis 2008</h1>
				<ul>
				<li><a href="#Publications - Journaux" title="Journaux">Journaux</a></li>
				<li><a href="#Publications - Conf&eacute;rences" title="Conf&eacute;rences">Conf&eacute;rences</a></li>
				<li><a href="#Contribution &agrave; des applications pratiques" title="Applications pratiques">Applications pratiques</a></li>
				</ul>
				...
				while($row = mysql_fetch_assoc($result))
				{
					...
					if ($url != "")
					{
						...
						?>
						<a href="<?php echo $u; ?>" target="_blank">[&nbsp;Site&nbsp;web&nbsp;]</a>&nbsp;&nbsp;&nbsp;&nbsp;
					...
					{
						?>
						<a href="/pdf/<?php echo $pdf; ?>" target="_blank">[&nbsp;PDF&nbsp;]</a>
